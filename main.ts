...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function on_menu_pressed() {
    ...
    Playa_List = [mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)), mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)), mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three)), mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Four))]
    if (mp.isButtonPressed(mp.playerSelector(mp.PlayerNumber.One), mp.MultiplayerButton.Right)) {
        animation.runImageAnimation(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)), [img`
                    . . . . . . . . . . . . . . . . 
                                . . . . . f f f f f f . . . . . 
                                . . . f f e e e e f 2 f . . . . 
    ...
    if (mp.isButtonPressed(mp.playerSelector(mp.PlayerNumber.Two), mp.MultiplayerButton.Right)) {
        animation.runImageAnimation(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)), [img`
                    . . . . . . . 5 . 5 . . . . . . 
                                . . . . . . f 5 5 5 f . . . . . 
                                . . . . . f 6 5 5 2 6 f . . . . 
                                . . . . f 6 6 1 6 6 6 6 f . . . 
    ...
    if (mp.isButtonPressed(mp.playerSelector(mp.PlayerNumber.Three), mp.MultiplayerButton.Right)) {
        animation.runImageAnimation(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three)), [img`
                    . . . . . . f f f f 4 4 f . . . 
                                . . . . f f b f 5 4 5 5 4 f . . 
    ...
    if (mp.isButtonPressed(mp.playerSelector(mp.PlayerNumber.Four), mp.MultiplayerButton.Right)) {
        animation.runImageAnimation(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Four)), [img`
                    . . . . . . . f f f f f . . . . 
                                . . . . . . f e e e e e f . . . 
                                . . . . . f e e e d d d d f . . 
...
function GeneratedTilemap() {
    ...
    while (tiles.locationXY(current_position, tiles.XY.column) > 0) {
        ...
        for (let index3 = 0; index3 < randint(3, 12); index3++) {
